...
?>
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('image/hero-header/01.jpg');">
				<div class="container">
							<h1>Discover great places in Nigeria</h1>
                             ...
                             <a href="nightlife.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/sam.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Nightlife</h5>
                                            <p>210 Listings</p>
                                        </figcaption>
                        ...
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                             <a href="shopping.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/banner2.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Shopping</h5>
                                            <p>114 Listings</p>
                                        </figcaption>
                        ...
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                             <a href="resturants.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/ima.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Restaurants</h5>
                                            <p>210 Listings</p>
                                        </figcaption>
                        ...
                        <div class="col-md-10">
                            <div class="find-place-img_wrap">
                             <a href="hangouts.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/ot.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Hangouts & Attractions</h5>
                                            <p>114 Listings</p>
                                        </figcaption>
                                    </figure>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                             <a href="hotel.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/popup.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Hotels & Guesthouse</h5>
                                            <p>577 Listings</p>
                                        </figcaption>
                                    </figure>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                             <a href="culture.php">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="image/at.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Art & Culture </h5>
                                            <p>79 Listings</p>
                                        </figcaption>
            ...
            <div class="row">
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.php">
                            <img src="image/featured1.jpg" class="img-fluid" alt="#">
                            <span class="featured-rating-green">Ad</span>
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.php">
                            <img src="image/featured2.jpg" class="img-fluid" alt="#">
                            <span class="featured-rating-green">Ad</span>
                            <div class="featured-title-box">
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.php">
                            <img src="image/featured3.jpg" class="img-fluid" alt="#">
                            <span class="featured-rating-green">Ad</span>
                            <div class="featured-title-box">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="promoted.php" class="btn btn-danger">VIEW ALL</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 category-responsive">
                    <a href="culture.php" class="category-wrap">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="spa.php" class="category-wrap">
                        <div class="category-block">
                            <svg class="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="" x="0px" y="0px" viewBox="0 0 469.824 469.824" style="enable-background:new 0 0 469.824 469.824;" xml:space="preserve" width="512px"
                                height="512px"><g><g>
              <g>
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="hotel.php" class="category-wrap">
                        <div class="category-block">
              ...
              <g>
                <g>
                  ...
                  <path d="M200.443,334.738h100.721c5.036,0,8.393-3.357,8.393-8.393c0-5.036-3.357-8.393-8.393-8.393H200.443     c-5.036,0-8.393,3.357-8.393,8.393C192.049,331.38,195.407,334.738,200.443,334.738z" data-original="#000000" class="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                            ...
                            <h6>Hotels & Guesthouse</h6>
                        </div>
                    </a>
                </div>
                <div class="col-md-3 category-responsive">
                    <a href="resturants.php" class="category-wrap">
                        <div class="category-block">
            ...
            <div class="row">
              ...
              <path d="M42,21c-2.206,0-4,1.794-4,4c0,0.553,0.448,1,1,1s1-0.447,1-1c0-1.103,0.897-2,2-2s2,0.897,2,2c0,0.553,0.448,1,1,1   s1-0.447,1-1C46,22.794,44.206,21,42,21z" data-original="#000000" class="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="bar.php" class="category-wrap">
                        <div class="category-block">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="nightlife.php" class="category-wrap">
                        <div class="category-block">
